...
const A_CONDITION_FACTOR: u64 = 4;
const B_CONDITION_FACTOR: u64 = 8;

const RUN_ITERATIONS: u32 = 5_000_000;
...
pub fn run() {
    ...
    let generator_a = generator::Generator::new(a, A_FACTOR, A_CONDITION_FACTOR);
    let generator_b = generator::Generator::new(b, B_FACTOR, B_CONDITION_FACTOR);
