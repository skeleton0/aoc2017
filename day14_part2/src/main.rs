...
fn main() {
    ...
    for lengths in length_sets.iter_mut() {
        knot_hashes.push(day14_part2::knot_hash_256_64(lengths));
    }
    ...
    let regions = day14_part2::count_regions(&frag_grid);

    println!("{} unique regions discovered in the frag grid.", regions);
}
